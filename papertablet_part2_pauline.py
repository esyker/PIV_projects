...
img_1 = cv2.imread('Input_data/rgb_0028.jpg')          # queryImage
...
imageHSV = cv2.cvtColor(img_1, cv2.COLOR_BGR2HSV)
skinRegionHSV = cv2.inRange(imageHSV, min_HSV, max_HSV)

img1 = cv2.bitwise_and(img_1, img_1, mask = cv2.bitwise_not(skinRegionHSV))
